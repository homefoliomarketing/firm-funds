...
Source files: `app/api/reports/referral-fees/route.ts`, `app/api/audit/export/route.ts`, `app/api/admin/reports/export/route.ts`, `app/api/brokerage/reports/export/route.ts` (with `lib/reports/build.ts`, `lib/reports/pdf.ts`, `lib/reports/xlsx.ts`, `lib/reports/types.ts`; `audience='brokerage'` strips Firm Funds margin).
