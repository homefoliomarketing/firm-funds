    ...
    sections: [
      {
        ...
        children: [
          ...
          richParagraph([{ text: '3.2 Purchase Discount. ', bold: true }, { text: `The Purchase Discount is ${r('{{PURCHASE_DISCOUNT}}')} (the "Purchase Discount"), calculated as follows: ${r('{{DISCOUNT_RATE}}')} of Face Value, for ${r('{{NUMBER_OF_DAYS}}')} days (being the number of calendar days from the day following the Funding Date to the day before the Expected Closing Date, inclusive; the Expected Closing Date itself is the day of repayment and is not charged).` }]),
    ...
    sections: [
      {
        ...
        children: [
          ...
          body('I acknowledge that interest at the rate of twenty-four percent (24%) per annum, as set out in Article 5.3 of the Original CPA, continues to accrue and compound daily on any unpaid Outstanding Balance (including any prior accrued interest) until satisfied in full, and that execution of this Remediation Direction to Pay does not stop the accrual of such interest.'),
